...
EVILFLOWERS_SEARCH_SERVICE_URL = os.getenv(
    "EVILFLOWERS_SEARCH_SERVICE_URL",
    os.getenv("SEARCH_SERVICE_URL", "http://127.0.0.1:8001"),
)
EVILFLOWERS_SEARCH_SERVICE_TIMEOUT = int(os.getenv("EVILFLOWERS_SEARCH_SERVICE_TIMEOUT", "30"))
