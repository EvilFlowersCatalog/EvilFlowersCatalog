...
from django.contrib.postgres.operations import HStoreExtension, CreateExtension, UnaccentExtension
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "relation",
                    models.CharField(
                        choices=[("acquisition", "acquisition"), ("open-access", "open-access")],
                        default="acquisition",
                        max_length=20,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "acquisition",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="prices", to="core.acquisition"
                    ),
                ),
                (
                    "currency",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="+", to="core.currency"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "catalog",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="entries", to="core.catalog"
                    ),
                ),
                (
                    "category",
                ...
                (
                    "language",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, related_name="+", to="core.language"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "platform",
                    models.TextField(
                        choices=[("debug", "debug"), ("custom", "custom"), ("user", "user")],
                        default="user",
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="acquisitions", to="core.entry"
            ),
        ),
        migrations.CreateModel(
            name="Feed",
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        choices=[("navigation", "navigation"), ("acquisition", "acquisition")], max_length=20
                    ),
                ),
                ...
                (
                    "catalog",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="feeds", to="core.catalog"
                    ),
                ),
                (
                    "creator",
